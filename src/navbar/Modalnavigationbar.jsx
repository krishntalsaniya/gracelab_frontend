                ...
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item"><Link to="/" className="nav-link">Network <FaAngleDown /></Link>
                    <ul className="dropdown-menu">
                      ...
                      <li className="nav-item"><Link to="/pharmacy" className="nav-link" onClick={() => handleLinkClick('Pharmacy')}>Pharmacy</Link></li>
                      <li className="nav-item"><Link to="/doctor" className="nav-link"onClick={() => handleLinkClick('Doctors')}>Doctors</Link></li>
                      <li className="nav-item"><Link to="/hospital" className="nav-link"onClick={() => handleLinkClick('Hospital')}>Hospital</Link></li>
                      <li className="nav-item"><Link to="/patient-login" className="nav-link"onClick={() => handleLinkClick('Patients')}>Patients</Link></li>
                    </ul>
                  </li>
