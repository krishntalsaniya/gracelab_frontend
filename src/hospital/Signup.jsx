...
//               <div className="img" style={{backgroundImage:`url(${props.signupimage})`}}>
//               </div>
...
//                         <Form.Control type="text" placeholder={props.namep} required />
//                       </Col>
//                       <Col lg={6} className="form-group mb-3">
...
//                       </Col>
//                       <Col lg={6} className="form-group mb-3">
//                         <Form.Label>{props.contact}</Form.Label>
...
//                       </Col>
//                       <Col lg={6} className="form-group mb-3">
//                         <Form.Label>{props.confirmpass}</Form.Label>
//                         <Form.Control type="password" placeholder="Confirm Password" required />
//                       </Col>
//                       <Col lg={6} className="form-group mb-3">
//                         <Form.Label>{props.licenceno}</Form.Label>
//                         <Form.Control type="text" placeholder={props.licencep} required />
//                       </Col>
//                       <Col lg={6} className="form-group mb-3">
//                         <Form.Label>{props.licencedate}</Form.Label>
//                         <Form.Control type="date" placeholder="Hospital License Date" required />
//                       </Col>
//                       <Col lg={6} className="form-group mb-3">
//                         <Form.Label>{props.pincode}</Form.Label>
...
//                   </div>
//                 </Form>
//                 <p className="text-center">Already have an account? <Link to={props.signup} className="d-inline-block">Sign In</Link></p>
//               </div>
//             </div>
//           </Col>
